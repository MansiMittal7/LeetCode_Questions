# Twice Counter
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a list of N words. Count the number of words that appear exactly twice in the list.</span></p>
...
appears twice. </span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
only words that appears twice. </span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
